                            ...
                            <div class="main_menu menu_position"> 
                                <nav>  
                                    <ul>
                                        ...
                                        <li><a href="addpet.php" style="font-family:georgia;">Add Pet details</a></li>
										<li><a href="viewpet.php" style="font-family:georgia;">View Pet details</a></li>
										<li><a href="viewrequest.php" style="font-family:georgia;">View Request</a></li>
										<li><a href="feedback.php" style="font-family:georgia;">feedback</a></li>
										<li><a href="myaccount.php" style="font-family:georgia;">My Account</a></li>

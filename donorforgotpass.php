                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="account-content"> 
                                    <form action="#" method="post">
										...
										<div class="single-acc-field">
                                            <input type="text" id="ans" name="answer" placeholder="Answer" required>
                                        </div>
										...
										<a href="donorlogin.php" style="font-family:georgia;">Back</a>
                                    </form>
									<?php
if(isset($_POST['submit']))
{
	...
	$sql="update donorregister set dpassword='".$password."' where demail='".$email."' and dquestion='".$question."' and danswer='".$answer."'";

...
<div id="form-container">
  ...
  <div id="card-front">
    ...
    <div id="image-container">
     Paying Amount &nbsp;<input style="width:80; height:40; font-size:20;" type="text" name="total" value="<?php echo $tot; ?>" readonly="true"/>
    ...
    <input type="text" id="card-number" placeholder="1234 5678 9101 1112" length="16" maxlength="20" required>
    <div id="cardholder-container">
      <label for="card-holder">Card Holder
      </label>
      <input type="text" id="card-holder" placeholder="e.g. John Doe" maxlength="25" pattern="[A-Za-z]+" title="letters only" required>
    </div>
    ...
    <div id="exp-container">
      ...
      <input id="card-month" type="text" placeholder="MM" length="2" maxlength="2" required>
      <input id="card-year" type="text" placeholder="YY" length="2" maxlength="2" required>
    </div>
        <div id="cvc-container">
      <label for="card-cvc"> CVC/CVV</label>
      <input id="card-cvc" placeholder="XXX-X" type="password" maxlength="4" required>
...
<br><br>
  ...
  <input type="submit" id="" name="pay" value="Pay" style="margin-top:300px;margin-left:300px; width:100px;"/>
...
<?php
    ...
    if(isset($_POST['pay'])){
            // Insert record
            $query = "update ordertb set payment='paid' where userid='".$_SESSION['petuser']."'";

					...
					<center><h3 style="background-color:#1EDE08;font-family:georgia;">Update address</h3></center>
						...
						<?php
							...
							<div class="col-12 mb-20" style="font-family:times;">
                                    <label>Address </label>
                                    <input placeholder="Enter the address" type="text" value="<?php if($count>0){ echo $adr1; }?>"name="addr1">     
                                </div>
								<div class="col-12 mb-20">
                                    <label>Alternate Address</label>
                                    <input placeholder="Enter the alternate address" type="text" value="<?php if($count>0){ echo $adr2; }?>" name="addr2">     
                                </div>
								<div class="col-12 mb-20">
                                    <label>City</label>
                                    <input placeholder="Enter the name of the city" type="text" value="<?php if($count>0){ echo $city; }?>" name="city">     
                                </div>
								<div class="col-12 mb-20">
                                    <label>Pin Code</label>
                                    <input placeholder="Enter the pincode" type="text" maxlength="6" value="<?php if($count>0){ echo $code; }?>" name="pin">     
                                </div>
								<div class="col-12 mb-20">
                                    <label>Contact Number</label>
                                    <input placeholder="Enter the contact number" type="tel"  maxlength="10" value="<?php if($count>0){ echo $phone; }?>" name="phone">     
                                </div>
